...
import { idlFactory } from './main_canister.did.js';
export { idlFactory } from './main_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MAIN_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./main_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the main_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./main_canister.did.js")._SERVICE>}
 */
export const main_canister = createActor(canisterId);
