...
import { idlFactory } from './zk_canister.did.js';
export { idlFactory } from './zk_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ZK_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./zk_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the zk_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./zk_canister.did.js")._SERVICE>}
 */
export const zk_canister = createActor(canisterId);
